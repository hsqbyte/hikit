...
import {
    SelectRepo as GitSelectRepo, OpenRepo as GitOpenRepo, GetStatus as GitGetStatus,
    GetDiff as GitGetDiff, GetFileDiff as GitGetFileDiff,
    Stage as GitStage, StageAll as GitStageAll, Unstage as GitUnstage, UnstageAll as GitUnstageAll,
    Commit as GitCommit, GetLog as GitGetLog, GetBranches as GitGetBranches,
    Checkout as GitCheckout, CreateBranch as GitCreateBranch,
    Push as GitPush, Pull as GitPull, Fetch as GitFetch, DiscardFile as GitDiscardFile,
} from '../../../wailsjs/go/git/GitService';
import './GitPanel.css';
